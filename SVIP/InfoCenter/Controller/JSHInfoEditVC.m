...
- (void)setting:(id)sender
{
  ...
  [[ZKJSHTTPSessionManager sharedInstance] updateUserInfoWithUserID:userId token:token username:baseInfo.username realname:nil imageData:imageData imageName:@"abc" sex:baseInfo.sex company:baseInfo.company occupation:baseInfo.position email:nil tagopen:nil success:^(NSURLSessionDataTask *task, id responseObject) {
