...
//    tableView.reloadRowsAtIndexPaths([indexPath], withRowAnimation: UITableViewRowAnimation.Automatic)
  ...
  func loadMoreData() -> Void {
    ...
    ZKJSHTTPSessionManager.sharedInstance().getOrderHistoryListWithUserID(userID, token: token, page: page, success: {  (task: NSURLSessionDataTask!, responseObject: AnyObject!) -> Void in
