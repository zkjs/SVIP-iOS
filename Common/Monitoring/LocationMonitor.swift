...
extension LocationMonitor : CLLocationManagerDelegate {
  ...
  private func uploadLocation (location:CLLocation) {
    ...
    HttpService.sharedInstance.sendGpsChanges(location.coordinate.latitude, longitude: location.coordinate.longitude, altitude: location.altitude, timestamp: Int64(NSDate().timeIntervalSince1970 * 1000),mac:bssid,ssid:ssid, completionHandler: nil)
