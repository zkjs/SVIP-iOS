...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "MessageDisplayKit/MessageDisplayKit/Resources/ic_jianpan2@2x.png"
  install_resource "MessageDisplayKit/MessageDisplayKit/Resources/ic_jianpan2@3x.png"
